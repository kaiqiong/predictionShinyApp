             ...
             fluidRow(
               column(width = 4,
                      wellPanel(
                        ...
                        radioButtons("SEX", label = h4("Sex"),
                                     ...
                                     selected = "male"),
                        radioButtons("Disease", label = h4("Type of Disease"),
                        ...
                        radioButtons("Resection", label = h4("Type of Procedure "),
                                     ...
                                     selected = "POUCH"),
                        radioButtons("Elective_Surgery", label = h4("Elective Surgery"),
                                     choices = list("No" = "No", "Yes" = "Yes"),
                                     selected = "Yes"),
                        radioButtons("Major_Morbidity", label = h4("Major Morbidity"),
                                     choices = list("No" = "0", "Yes" = "1"),
                                     selected = "1"),
                        radioButtons("STEROID", label = h4("Steroid"),
                                     choices = list("No" = "No", "Yes" = "Yes"),
                                     selected = "No"),
                        radioButtons("SMOKing", label = h4("Smoking"),
                                     choices = list("No" = "No", "Yes" = "Yes"),
                                     selected = "Yes"),
                        radioButtons("Hypertension_On_Medication", label = h4("Hypertension"),
                                     choices = list("No" = "No", "Yes" = "Yes"),
                                     selected = "Yes"),
                        radioButtons("DIABETES", label = h4("Diabete"),
                                     choices = list("No" = "NO", "Yes" = "YES"),
                                     selected = "YES")
                      ),
               ...
               column(width = 8,
                      mainPanel(width = 12,
                                ...
                                plotOutput('plot'),
                                br(),
                                helpText("The solid black line represents probabilities for different ages while holding all other variables at their inputted value. ",
